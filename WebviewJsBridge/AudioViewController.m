...
- (void)_initBtnView{
    ...
    self.record.frame = CGRectMake(20, self.view.frame.size.height - 100, 60, 40);
    ...
    self.pause.frame = CGRectMake(90, self.view.frame.size.height - 100, 60, 40);
    ...
    self.resume.frame = CGRectMake(160, self.view.frame.size.height - 100, 60, 40);
    ...
    self.stop.frame = CGRectMake(230, self.view.frame.size.height - 100, 60, 40);
    [self.stop setTitle:@"停止" forState:UIControlStateNormal];
    [self.view addSubview:self.stop];
    
    self.audioPower = [[UIProgressView alloc] initWithFrame:CGRectMake(20, self.view.frame.size.height/2, self.view.frame.size.width - 40, 5)];
    [self.view addSubview:self.audioPower];
    
    UIButton *closeBtn = [UIButton buttonWithType:UIButtonTypeCustom];
    closeBtn.frame = CGRectMake(self.view.frame.size.width - 100, 0, 100, 60);
